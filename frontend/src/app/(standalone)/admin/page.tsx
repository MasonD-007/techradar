...
const mockActivity = [
    { id: "1", action_type: "Technology Created", description: "Added React to tools quadrant", user: "Admin", created_at: "2026-04-15 10:30" },
    { id: "2", action_type: "User Created", description: "Created user John Doe", user: "Admin", created_at: "2026-04-15 09:15" },
    { id: "3", action_type: "Technology Updated", description: "Updated TypeScript quadrant", user: "Admin", created_at: "2026-04-14 16:45" },
    { id: "4", action_type: "Blip Deleted", description: "Removed old blip data", user: "Admin", created_at: "2026-04-14 14:20" },
    { id: "5", action_type: "Bulk Import", description: "Imported 10 technologies", user: "Admin", created_at: "2026-04-13 11:00" },
    { id: "6", action_type: "Technology Created", description: "Added Docker to tools", user: "Admin", created_at: "2026-04-13 09:30" },
    { id: "7", action_type: "User Deleted", description: "Removed user test@example.com", user: "Admin", created_at: "2026-04-12 15:00" },
    { id: "8", action_type: "Technology Created", description: "Added Kubernetes to platforms", user: "Admin", created_at: "2026-04-12 11:45" },
];
...
export default function AdminPage() {
    ...
    const [newTechnology, setNewTechnology] = useState({ name: "", quadrant_id: "", blip_id: "" });
    ...
    const [techFormErrors, setTechFormErrors] = useState<{ name?: string; quadrant_id?: string }>({});
    const [importFile, setImportFile] = useState<File | null>(null);
    const [importPreview, setImportPreview] = useState<{ name: string; quadrant_id: string }[] | null>(null);
    ...
    const filteredTechnologies = technologies.filter((tech: Technology) => {
        ...
        const matchesSearch = searchTerm === "" || techName.toLowerCase().includes(searchTerm.toLowerCase());
        const matchesQuadrant = quadrantFilter === "all" || String(tech.quadrant_id) === quadrantFilter;
    ...
    const handleExport = () => {
        const data = { technologies: technologies.map((t) => ({ name: t.name, quadrant_id: t.quadrant_id, blip_id: t.blip_id })) };
                ...
                <TabsContent value="overview">
                    <div className="space-y-6">
                        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                            ...
                            <Card>
                                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                    <CardTitle className="text-sm font-medium">Total Blips</CardTitle>
                                </CardHeader>
                                <CardContent>
                                    <div className="text-2xl font-bold">{stats.totalBlips}</div>
                                </CardContent>
                            </Card>
                            <Card>
                                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    <Table>
                                        ...
                                        <TableBody>
                                            {technologies.slice(0, 5).map((tech: Record<string, unknown>) => (
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-4">
                            ...
                            <Select
                                ...
                                onValueChange={setQuadrantFilter}
                            >
                            ...
                            <Dialog open={isAddTechnologyOpen} onOpenChange={setIsAddTechnologyOpen}>
                                ...
                                <div className="space-y-4">
                                    <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
                                        ...
                                        <p className="mt-2 text-sm text-gray-600">
                                            Drag and drop a JSON file here, or click to
                                            select
                                        </p>
                                        <input
                                            type="file"
